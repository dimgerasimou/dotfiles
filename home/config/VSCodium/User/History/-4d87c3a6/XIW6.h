...
/*
 * loads an unsigned integer from a variable saved in a file.
 */
 ...
 */
int matrixsave(IOHeader header, Matrix_t *idx, Matrix_t *dst);
...
Matrix_t** knnsearchdouble(Matrix_t *C, Matrix_t *Q, uint32_t *K, uint32_t blocksize);
Matrix_t** knnsearchsingle(Matrix_t *C, Matrix_t *Q, uint32_t *K, uint32_t blocksize);
