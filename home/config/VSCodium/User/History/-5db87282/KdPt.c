...
const char *CAL_PATH[]      = {"usr", "bin", "zen-browser", NULL};
const char *CAL_ARGS[]      = {"zen-browser", "--new-window", "https://calendar.google.com", NULL};
...
exec_block_button(void)
{
	...
	case 3:
	{
		...
		forkexecvp((char **) CAL_ARGS, "dwmblocks-date");
