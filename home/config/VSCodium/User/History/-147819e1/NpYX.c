 ...
 * even though with total memory > L2 cache size, the loop overhead cost of the iterations overshadow
 * the cache misses penalty. By trial: e.g. for max_blocksize = 153, a blocksize of 256 is faster than 128.
 *  - tested for dimensions up to 1000
*/
void
